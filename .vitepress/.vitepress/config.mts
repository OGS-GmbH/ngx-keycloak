...
export default defineConfig({
  title: "ngx-keycloak",
  description: "A package that provides a seamless interface for integrating Keycloak authentication into Angular applications",
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: "GitHub", link: "https://github.com/OGS-GmbH/ngx-keycloak" }
    ],
    socialLinks: [
  ...
  srcDir: "../dist/typedoc",
  outDir: "../dist/docs",
  titleTemplate: ":title - OGS Keycloak",
  cleanUrls: true,
  appearance: "dark",
  markdown: {
    config(md) {
